...
public class main {
	...
	public static void main(String[] args) {
		...
		//Programa 2 (if-else)
		//o comando if-else é uma condicional que serve para comparar situações, onde pode haver uma ou mais situações validas (if - else if)
		//e uma situação inválida, que não se enquadra nas comparações (else) 
		...
		//o switch-case é utilizado para a seleção de diversos casos, em que cada caso vai executar um comando (ou uma série de comandos) 
		//diferente, tendo também o caso default, que é o caso que não se enquadra em nenhuma das condições anteriores 
		...
		//o while/do-while/for executa um comando dentro de um laço até que a condição estabelecida se torne falsa  
		...
		//as matrizes (arrays) são um conjunto de valores fixos agrupados
