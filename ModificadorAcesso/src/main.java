...
public class main {
	...
	public static void main(String[] args) {
		...
		//Método 1 - criando um novo objeto da classe ContaBancaria 
		ContaBancaria conta1 = new ContaBancaria(true, 3.0);
		
		//atribuição de valores aos atributos que foram vinculados (atribuídos) ao objeto conta1
		conta1.ativo = true;
		...
		//atribuição dos métodos dar e receber ao objeto conta1 
		conta1.receber(0);
		conta1.dar(0);
		conta1.saldo();
		...
		//Método 2 - criando um novo objeto da classe Cliente
		Cliente cliente1 = new Cliente();
		
		//atribuição de valores aos atributos que foram vinculados (atribuídos) ao objeto cliente1 
		//(fazendo uso do método set)
